...
class NeuralNet(nn.Module):
    def __init__(self, lrate, loss_fn, in_size, out_size):
        ...
        self.lrate = lrate
        self.neuralNet = nn.Sequential(nn.Linear(in_size, 165), nn.ReLU(), nn.Linear(165, out_size))
        self.optimiser = optim.SGD(self.neuralNet.parameters(), self.lrate, momentum=0.9)
